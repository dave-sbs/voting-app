...
// import { useVotingContext } from '../(context)/NewContext';
// import CardHeader from '@/components/CardHeader';
// import SecondaryButton from '@/components/SecondaryButton';

// const summaryPage = () => {

//     const { votes, updateVotes } = useVotingContext();
...
//                         <View className='flex-row'>
//                             <View className='border-l-2 border-b-2 w-[5%] h-10 items-center justify-center'>
//                                 <Text>{votes.indexOf(item) + 1}</Text>
//                             </View>
...
//                 <View className='py-4'>
//                     <SecondaryButton title="Reset Data" handlePress={resetVotes}  />
//                 </View>
//             </View>
//         </ScrollView>
//       </SafeAreaView>
